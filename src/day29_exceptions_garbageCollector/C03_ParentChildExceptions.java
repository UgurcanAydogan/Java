...
public class C03_ParentChildExceptions {
    ...
    public static void main(String[] args) {
        ...
        /*
           ...
           ve bu exceptin'lar arasinda Parent - Child iliskisi olursa

           once Child, sonra Parent yazilmalidir.

           Tersi yapilirsa
           yani once Parent yazilirsa
           Parenr exception'in yakalam kapasitesi daha fazla oldugundan
           tum olasi exception'lari yakalayacak
           ve altdaki Child exception'a is kalmayacaktir.
