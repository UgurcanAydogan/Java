...
public class C01_NestedMapOlusturma {
    public static void main(String[] args) {
        ...
        // Key = 101  Valur = "Ali-Can-11-H-MF"
        // Key = 101  Valur Map olusun { isim = Ali, soyisim = Can, sınıf = 11, sube = H, bolum = MF }

        // ogrenci map'i { 101 = ogrMap101, 102 = ogrMap102, 103 = ogrMap103 }

        Map<Integer, Map<String, String>> ogrenciMap = new HashMap<>(); // Outer Map

        // 101 numarali ogrenciyi eklemek istersek, once value map'ini olusturmaniz gerekir
