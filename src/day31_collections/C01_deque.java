...
public class C01_deque {
    public static void main(String[] args) {
        ...
        System.out.println(harfler.add("e"));
        harfler.addLast("K");
        harfler.addFirst("A");
        ...
        // harfler.remove("A"); --> A'nin ilk kulanimini siler
        // harfler.removeFirst(); --> ilk elementi siler
        // harfler.removeFirstOccurrence("A"); --> A'nin ilk elementini siler
        ...
        // eger deque icin bir eleman siralamasi varsa
        ...
        // ama kapasite sinirlamssi olan durumlarda
        // kapasite asilirs eklemek yerine exception firlatir
